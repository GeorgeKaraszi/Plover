defmodule Plover.Slack.SlackTest do
  ...
  describe "slack_message!" do
    test "pull_request" do
        ...
        [title, attachment] = Slack.slack_message!("pull_request", slack_state, nil)
        assert String.contains?(slack_state.targeted_users) == true
  ...
  describe "find_message!" do
    ...
    test "returns nil if one doesn't exist" do
        assert Slack.find_message("123") == nil
    end
